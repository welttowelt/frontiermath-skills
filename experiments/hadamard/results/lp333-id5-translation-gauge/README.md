# LP333 ID5: independent normalized-translation gauge
...
For ID5 the translations preserving the fixed H-invariant space are exactly
...
incomplete proof was 903,361,631 bytes, peak observed RSS was 947,273,728
bytes, and it explored 1,901,171 conflicts. This removes the baseline's early
proof-cap failure and reduces conflicts by 21.16%, but does not decide ID5.
